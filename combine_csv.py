...
# combined_csv_path = (
#     "data/output_parallel/combined_median.csv"  # Adjust to your combined CSV file path
# )


def aggregate_csv_median(output_folder, aggregate_csv_path):
    ...
    for column, values in data.items():
        ...
        if column in ["grid_id", "latitude", "longitude"]:
            median_data[column] = values[
                0
            ]  # Copy the first file's data for non-class columns
        else:
    ...
    median_df.to_csv(aggregate_csv_path)
